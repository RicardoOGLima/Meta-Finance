    ...
    <div className="space-y-8 animate-in slide-in-from-right-4 duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                {goals.map((g) => (
                  <tr key={g.class} className="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
                    <td className="px-6 py-4">
                      <InvestmentBadge className={g.class} />
                    </td>
                    <td className="px-6 py-4 flex justify-center">
                      <div className="relative w-full max-w-[100px] flex items-center bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl focus-within:ring-2 focus-within:ring-blue-600 transition-all overflow-hidden shadow-sm">
                        <input 
                          type="number"
                          step="0.1"
        ...
        <div className="space-y-6">
          <div className={`p-6 rounded-2xl border flex flex-col items-center gap-4 text-center transition-all duration-300 ${
            isValid ? 'bg-green-50 dark:bg-green-500/10 border-green-100 dark:border-green-800' : 'bg-red-50 dark:bg-red-500/10 border-red-100 dark:border-red-800'
          }`}>
            {isValid ? (
              <>
          ...
          <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 transition-colors">
            <h4 className="font-bold mb-4 flex items-center gap-2 text-slate-900 dark:text-slate-100">
