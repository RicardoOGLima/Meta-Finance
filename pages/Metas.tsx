  ...
  return (
    <div className="space-y-8 animate-in slide-in-from-right-4 duration-500">
      <PageHeader
        ...
        description="Defina o destino ideal do seu dinheiro."
        action={
          <button
            disabled={!isValid}
            onClick={handleSave}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          <div className={`p-6 rounded-2xl border flex flex-col items-center gap-4 text-center transition-colors duration-300 ${isValid ? 'bg-green-50 dark:bg-green-900/20 border-green-100 dark:border-green-800' : 'bg-red-50 dark:bg-red-900/20 border-red-100 dark:border-red-800'
            }`}>
            {isValid ? (
              <>
            ...
            <div className="text-sm text-slate-500 space-y-3 leading-relaxed">
              ...
              {totalIncome === 0 && (
                <div className="flex items-start gap-2 p-3 bg-amber-50 dark:bg-amber-900/20 rounded-lg text-amber-700 dark:text-amber-400 font-medium">
                  <span className="shrink-0 mt-0.5"><AlertCircle size={18} /></span>
